...
<html lang="en">
  <head>
    ...
    <title>Elysium Computer Club</title>
    <!-- Bootstrap -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8 wp1">
			  ...
			  <p>Office Number : 04 - 7474757</p>
              <p>Fax Number : 03 - 9565238</p>
			  <p>Phone Number : 012 - 3456789</p>
			  <p>Email : <a href="mailto:elysium@gogo.com">elysium@comp.club</a></p>
			  <p>Main School Website : <a href="#">Click here to know more about it.</a></p>
